...
public class JwtServiceIMPL implements JwtService {
	...
	@Override
	public String generateToken(CustomUserService userDetails) {
		log.debug("generateToken({})", userDetails.getEmail());
		return generateToken(new HashMap<>(), userDetails);
	}

	@Override
	public String generateToken(Map<String, Object> extraClaims, CustomUserService userDetails) {
	...
	private String buildToken(Map<String, Object> extraClaims, CustomUserService userDetails, long expiration) {
	...
	@Override
	public boolean isTokenValid(String token, CustomUserService userDetails) {
